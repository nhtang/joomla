...
// insert to database
ModMeterModelSubmitHelper::insertMetermodelValues($datetime_create, $meter_model, $meter_factory, $command_code, $command_code2, $var_len,  $function_code, $storage_start_address, $storage_numbers, $data_index, 
